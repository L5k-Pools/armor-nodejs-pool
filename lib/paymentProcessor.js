...
function runInterval () {
	async.waterfall([
		...
		function (balances, minPayoutLevel, callback) {
			...
			if (daemonType === "default" && transferCommands.length > 1) { // TODO: Limit to sent just 1 transaction. I don't know why it fails if I sent more than one
